        ...
        <el-form ref="loginForm" :model="loginFormData" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
            ...
            <el-tooltip v-model="capsTooltip" content="Caps lock is On" placement="right" manual>
                <el-form-item prop="password">
                    ...
                    <el-input :key="passwordType" ref="password" v-model="loginFormData.password" :type="passwordType" placeholder="Password" name="password" tabindex="2" autocomplete="on" @keyup="checkCapslock" @blur="capsTooltip = false" @keyup.enter="handleLogin" />
...
export default {
    ...
    setup() {
        ...
        const redirect = ref(undefined), otherQuery = reactive({})
        ...
        const getOtherQuery = (query) => Object.keys(query).reduce((acc, cur) => {
            if (cur !== 'redirect') {
                acc[cur] = query[cur]
            }
            return acc
        ...
        const handleLogin = () => {
            loginForm.value.validate(valid => {
                ...
                if (valid) {
                    loading.value = true
                    store.dispatch('user/login', loginFormData)
                        .then(() => {
